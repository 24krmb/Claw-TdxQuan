...
import pandas as pd
import vectorbt as vbt    #安装1. pip install vectorbt -i https://pypi.tuna.tsinghua.edu.cn/simple    安装2.pip install plotly 用于打印html交互式图形
...
# ========================= 核心配置（用户可直接修改这里）=========================
target_start = '20260101'  # 【目标回测开始时间】（真正想回测的起始日）
target_end = '20260710'    # 【目标回测结束时间】
